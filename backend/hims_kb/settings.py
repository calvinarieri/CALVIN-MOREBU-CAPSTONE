"""
Django settings for hims_kb project.
...
WSGI_APPLICATION = 'hims_kb.wsgi.application'
...
if DB_ENGINE == "mysql":
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("DB_NAME") or os.getenv("POSTGRES_DB") or "hims_kb",
            ...
            "PORT": os.getenv("DB_PORT") or os.getenv("POSTGRES_PORT") or "3306",
        }
    }
else:
    DATABASES = {
